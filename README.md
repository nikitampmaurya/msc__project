...
i. Downloaded datasets (GSE207350, GSE192354, GSE169255, GSE268710) from the Gene Expression Omnibus (GEO) database. Available inside the Folder MSc_project as Sample_1_(GSE207350), Sample_2_(GSE192354), Sample_3_(GSE169255) and GSE268710_RAW. These datasets underwent data preprocessing. Script is available in the folder MSc_project as Code_part1_preprocessing.R
